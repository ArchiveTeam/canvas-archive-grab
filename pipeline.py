...
project = Project(
    title="Canvas",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/0/0d/Canvas-beta-logo-medium.png" height="50px" title=""/>
        <h2>Canvas <span class="links"><a href="">Website</a> &middot; <a href="http://tracker.archiveteam.org/canvas/">Leaderboard</a></span></h2>
        <p>Archiving Canvas temporary archives.</p>
    """,
    utc_deadline=datetime.datetime(2014, 8, 13, 23, 59, 0)
)
